...
import html
import requests
import Natsuki.modules.sql.kuki_sql as sql
...
from Natsuki import dispatcher, updater, SUPPORT_CHAT
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        name = message.text[len("/name ") :]
        bot.send_chat_action(chat_id, action="typing")
        kukiurl = requests.get('https://kukiapi.xyz/api/apikey=KUKItg111XlOZ/Natsuki/moezill/message='+Message)
...
*Powered by @kukiupdates From ItelAi*
"""
