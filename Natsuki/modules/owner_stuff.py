...
# Copyright (C) 2020 Sadew Jayasekara
...
from Natsuki import DAISY_VERSION, OWNER_ID, bot, dp
from Natsuki.decorator import COMMANDS_ALIASES, REGISTRED_COMMANDS, register
from Natsuki.modules import LOADED_MODULES
from Natsuki.services.mongo import db, mongodb
from Natsuki.services.redis import redis
...
async def restart_bot(message):
    await message.reply("Natsuki will be restarted...")
