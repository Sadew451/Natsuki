...
async def select_lang_keyboard(message, strings, edit=False):
    ...
    markup.add(
        InlineKeyboardButton(
            strings["crowdin_btn"], url="https://t.me/Natsukisupport_official"
        )
    )
    if edit:
...
__help__ = """
This module is dedicated towards utlising Natsuki's localization feature! You can also <a href=Natsuki'>contribute</a> for improving localization in Natsuki!
<b>Available commands:</b>
- /lang: Shows a list of avaible languages
- /lang (language codename): Sets a language
<b>Example:</b> <code>/lang</code>
Natsuki will send you bunch of inline buttons where you can select your prefered language interatively without any hassles!
"""
